...
class ConfiguracionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('TekneiCtrlBundle:configuracion:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('configuracion_show', array('id' => $configuracion->getIdconfiguracion()));
        }

        return $this->render('TekneiCtrlBundle:configuracion:new.html.twig', array(
    ...
    public function showAction(Configuracion $configuracion)
    {
        ...
        return $this->render('TekneiCtrlBundle:configuracion:show.html.twig', array(
            'configuracion' => $configuracion,
    ...
    public function editAction(Request $request, Configuracion $configuracion)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('configuracion_edit', array('id' => $configuracion->getIdconfiguracion()));
        }

        return $this->render('TekneiCtrlBundle:configuracion:edit.html.twig', array(
            'configuracion' => $configuracion,
    ...
    private function createDeleteForm(Configuracion $configuracion)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('configuracion_delete', array('id' => $configuracion->getIdconfiguracion())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
