...
class DescuentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('descuento/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('descuento_show', array('id' => $descuento->getId()));
        }

        return $this->render('descuento/new.html.twig', array(
            'descuento' => $descuento,
    ...
    public function showAction(Descuento $descuento)
    {
        ...
        return $this->render('descuento/show.html.twig', array(
            'descuento' => $descuento,
    ...
    public function editAction(Request $request, Descuento $descuento)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('descuento_edit', array('id' => $descuento->getId()));
        }

        return $this->render('descuento/edit.html.twig', array(
            'descuento' => $descuento,
    ...
    private function createDeleteForm(Descuento $descuento)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('descuento_delete', array('id' => $descuento->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
